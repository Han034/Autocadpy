...
class Application(tk.Tk):
    ...
    def create_widgets(self):
        ...
        self.frame_his3_TIP3 = ttk.Frame(self.notebook, padding="10 10 10 10")
        ...
        self.notebook.add(self.frame_his3_TIP3, text='PLAN(T3)')
        ...
        self.create_form_his3_TIP3(self.frame_his3_TIP3)
    ...
    def create_form_his2_TIP2(self, parent):
        ...
        # Define form labels and entries
        labels = ["H2_LEN","H3_LEN","H5_LEN","H5X_LEN","H6_LEN","H7_LEN","H9_LEN","H9X_LEN","H10_LEN","H10X_LEN","H15_LEN","H16_LEN","H17_LEN","H18_LEN","H19_LEN","H19X_LEN","H20_LEN","H20X_LEN","Q100"
                  ]
    ...
    def create_form_his3_TIP3(self, parent):
        # Frame for form inputs and image
        form_image_frame = ttk.Frame(parent, padding="10 10 10 10", borderwidth=2, relief="sunken")
        form_image_frame.grid(row=0, column=0, columnspan=2, sticky=(tk.W, tk.E, tk.N, tk.S), padx=10, pady=10)
        ...
        # Load and display the image
        try:
            image = Image.open("pro+/pictures/HIS3_TIP.jpg")  # İkinci resim yolu
            image = image.resize((800, 400), Image.LANCZOS)  # Adjust size to fit larger area
        ...
        # Define form labels and entries
        labels = ["H9_LEN","H10_LEN","H1_LEN","H3_LEN","H4_LEN","H11_LEN","H13_LEN","H12_LEN","H14_LEN","H7_LEN","H12X_LEN","H3X_LEN","H2_LEN","H8_LEN","H40_LEN","H30_LEN","H20_LEN","H21_LEN"
                  ]
        ...
        # Button to save entries
        button = ttk.Button(form_image_frame, text="Çiz HIS3_TIP3", command=self.save_entries_form7)
        button.grid(row=2, column=0, pady=10)
    ...
    def save_entries_form7(self):
        # Get entries for form1
        data6 = {label: entry.get() for label, entry in self.entries7.items()}

        # Save to JSON file
        with open('input_data_form3_TIP3.json', 'w') as f:
            json.dump(data6, f)

        self.output_text.insert(tk.END, "Form1 verisi dosyaya yazıldı.\n")

        # Execute HIS.py
        self.execute_script("HIS_3_TIP3.py")    
